...
namespace esDnevnik
{
    public partial class drugoSest : UserControl
    {
        public drugoSest()
        {
            InitializeComponent();
        ...
        private void drugoSest_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string upit = "SELECT * FROM Student WHERE Class = 'II/6';";
        ...
        {
            String upit = "DELETE * FROM Student WHERE ID = 30";
